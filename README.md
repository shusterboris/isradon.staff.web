...
1. Добавлено подобное протоколирование создания/изменения пользователя и сотрудника, изменения прав пользователя, изменение данных для связи с системой Исрадон
2. Исправлен недочет: очистка имени существующего пользователя при сохранении
3. Добавлено: немедленное сохранение данных о пользователе при изменении полномочий
4. Добавлена функция: утвердить все, в соответствии с планом в расписании
5. Устранена ошибка: при отметке прихода или ухода для прошлого года, данные не перевысвечиваются (точнее обновляются для текущего года, показывая пустой список)
6. Выделяется цветом выбранная строка в таблице

Версия 1.3 2022-05-01

7. Устранены 3 ошибки перевода контекстного меню
